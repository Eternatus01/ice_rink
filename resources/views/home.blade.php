...
<section class="relative overflow-hidden bg-gradient-to-br from-ice-teal/10 via-white to-ice-sky/10">
    ...
    <div class="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 md:py-28">
        <div class="text-center max-w-3xl mx-auto">
            <h1 class="text-4xl md:text-5xl lg:text-6xl font-bold text-gray-800 mb-6 animate-fade-in">
                Ледовый каток
            </h1>
...
<section id="about" class="py-16 md:py-24 bg-white">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="grid md:grid-cols-3 gap-8">
            <div class="p-8 rounded-2xl bg-white border border-gray-100 shadow-card hover:shadow-card-hover transition-all duration-300 group">
...
<section id="prices" class="py-16 md:py-24 bg-gray-50">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="grid md:grid-cols-2 gap-8 max-w-2xl mx-auto">
            <div class="p-8 rounded-2xl bg-white shadow-card border-2 border-ice-teal hover:shadow-card-hover transition-all duration-300">
            ...
            <div class="p-8 rounded-2xl bg-white shadow-card border border-gray-100 hover:border-ice-peach hover:shadow-card-hover transition-all duration-300">
